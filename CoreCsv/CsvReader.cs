...
namespace CoreCsvLib
{
    ...
    {
        long ImportCsv(string path = null);
        long ImportCsv(Stream blob);
    ...
    public class CsvReader: ICsvReader
    {
        ...
        /// <param name="batchSize"></param>
        /// <param name="timeOut"></param>
        public CsvReader(string tableName = null, string connectionString = null, string delimiter = ",", int headerRowCount = 1, string colNames = null, int batchSize = 1000, int timeOut = 300)
        {
            _tableName = tableName;
            _connectionString = connectionString;
            _delimiter = delimiter;
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static ICsvReader Create(string tableName = null, string connectionString = null, string delimiter = ",", int headerRowCount = 1, string colNames = null, int batchSize = 1000, int timeOut = 300)
        {
            return new CsvReader(tableName, connectionString, delimiter, headerRowCount, colNames, batchSize, timeOut);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual long ImportCsv(string path = null)
        {
            _path = path ?? _path;
            ...
            return this.ReadCsv(_path);
        }

        public virtual long ImportCsv(Stream blob)
        {   
            if(blob == null)
                _error = "Parameter 'blob' must be an instance of Stream.";
            else if (c.IsEmpty(_tableName))
                _error = "Parameter 'tableName' is required.";
            else if (c.IsEmpty(_connectionString))
                _error = "Parameter 'connectionString' is required.";
        ...
        protected virtual void CreateDataTable()
        {
            ...
            try
            {
                ...
                _dataTable = _dataTable.Clone(); // remove first row.
            }
            catch (Exception ex)
            {
                _error = ex.ToString();
        ...
        protected virtual long ReadCsv(string path)
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual long ReadCsv(Stream blob)
        {
